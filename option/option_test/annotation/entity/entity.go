...
var file_idl_entity_thrift *thrift_reflection.FileDescriptor
...
func init() {
	if file_idl_entity_thrift != nil {
		return
	}
	file_idl_entity_thrift = thrift_reflection.BuildFileDescriptor(file_idl_entity_rawDesc, file_entity_thrift_go_types)
}

func GetFileDescriptorForEntity() *thrift_reflection.FileDescriptor {
	return file_idl_entity_thrift
}
func (p *_StructOptions) GetDescriptor() *thrift_reflection.StructDescriptor {
	return file_idl_entity_thrift.GetStructDescriptor("_StructOptions")
}
func (p *_FieldOptions) GetDescriptor() *thrift_reflection.StructDescriptor {
	return file_idl_entity_thrift.GetStructDescriptor("_FieldOptions")
}
func (p *PersonBasicInfo) GetDescriptor() *thrift_reflection.StructDescriptor {
	return file_idl_entity_thrift.GetStructDescriptor("PersonBasicInfo")
}
func (p *PersonContainerInfo) GetDescriptor() *thrift_reflection.StructDescriptor {
	return file_idl_entity_thrift.GetStructDescriptor("PersonContainerInfo")
}
func (p *PersonStructInfo) GetDescriptor() *thrift_reflection.StructDescriptor {
	return file_idl_entity_thrift.GetStructDescriptor("PersonStructInfo")
}
func (p *TestStruct) GetDescriptor() *thrift_reflection.StructDescriptor {
	return file_idl_entity_thrift.GetStructDescriptor("TestStruct")
}
func (p TestEnum) GetDescriptor() *thrift_reflection.EnumDescriptor {
	return file_idl_entity_thrift.GetEnumDescriptor("TestEnum")
}
func GetTypeDescriptorForTestStructTypedef() *thrift_reflection.TypedefDescriptor {
	return file_idl_entity_thrift.GetTypedefDescriptor("TestStructTypedef")
}
func GetTypeDescriptorForTestBasicTypedef() *thrift_reflection.TypedefDescriptor {
	return file_idl_entity_thrift.GetTypedefDescriptor("TestBasicTypedef")
}
