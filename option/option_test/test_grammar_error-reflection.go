...
// IDL Name: test_grammar_error
// IDL Path: option_idl/test_grammar_error.thrift
...
var file_test_grammar_error_thrift *thrift_reflection.FileDescriptor
...
func init() {
	if file_test_grammar_error_thrift != nil {
		return
	}
	type x struct{}
	builder := &thrift_reflection.FileDescriptorBuilder{
		Bytes:         file_idl_test_grammar_error_rawDesc,
		GoTypes:       file_test_grammar_error_thrift_go_types,
		GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
	}
	file_test_grammar_error_thrift = thrift_reflection.BuildFileDescriptor(builder)
}

func GetFileDescriptorForTestGrammarError() *thrift_reflection.FileDescriptor {
	return file_test_grammar_error_thrift
}
func (p *PersonA) GetDescriptor() *thrift_reflection.StructDescriptor {
	return file_test_grammar_error_thrift.GetStructDescriptor("PersonA")
}
func (p *PersonB) GetDescriptor() *thrift_reflection.StructDescriptor {
	return file_test_grammar_error_thrift.GetStructDescriptor("PersonB")
}
func (p *PersonC) GetDescriptor() *thrift_reflection.StructDescriptor {
	return file_test_grammar_error_thrift.GetStructDescriptor("PersonC")
}
func (p *PersonD) GetDescriptor() *thrift_reflection.StructDescriptor {
	return file_test_grammar_error_thrift.GetStructDescriptor("PersonD")
}
func (p *PersonE) GetDescriptor() *thrift_reflection.StructDescriptor {
	return file_test_grammar_error_thrift.GetStructDescriptor("PersonE")
}
func (p *PersonF) GetDescriptor() *thrift_reflection.StructDescriptor {
	return file_test_grammar_error_thrift.GetStructDescriptor("PersonF")
}
