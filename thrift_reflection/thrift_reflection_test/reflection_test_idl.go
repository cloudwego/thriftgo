...
func (p *Person) ReadField6(iprot thrift.TProtocol) error {
	...
	var _field SpecialString
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		_field = v
	}
	p.TypedefValue = _field
	return nil
}
...
func (p *A0) ReadField4(iprot thrift.TProtocol) error {
	...
	_field := make(map[*D]map[*E][]*F, size)
	for i := 0; i < size; i++ {
		_key := NewD()
...
func NewMyServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *MyServiceClient {
	return &MyServiceClient{
		MyParentServiceClient: NewMyParentServiceClientFactory(t, f),
	}
}

func NewMyServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *MyServiceClient {
	return &MyServiceClient{
		MyParentServiceClient: NewMyParentServiceClientProtocol(t, iprot, oprot),
	}
}

func NewMyServiceClient(c thrift.TClient) *MyServiceClient {
	return &MyServiceClient{
		MyParentServiceClient: NewMyParentServiceClient(c),
	}
}
...
func NewMyParentServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *MyParentServiceClient {
	return &MyParentServiceClient{
		MyAnotherServiceClient: NewMyAnotherServiceClientFactory(t, f),
	}
}
...
func NewMyParentServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *MyParentServiceClient {
	return &MyParentServiceClient{
		MyAnotherServiceClient: NewMyAnotherServiceClientProtocol(t, iprot, oprot),
	}
}

func NewMyParentServiceClient(c thrift.TClient) *MyParentServiceClient {
	return &MyParentServiceClient{
		MyAnotherServiceClient: NewMyAnotherServiceClient(c),
	}
}

func (p *MyParentServiceClient) M11(ctx context.Context) (r string, err error) {
	var _args MyParentServiceM11Args
	var _result MyParentServiceM11Result
	if err = p.Client_().Call(ctx, "M11", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *MyParentServiceClient) M22(ctx context.Context) (r string, err error) {
	var _args MyParentServiceM22Args
	var _result MyParentServiceM22Result
	if err = p.Client_().Call(ctx, "M22", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewMyServiceProcessor(handler MyService) *MyServiceProcessor {
	self := &MyServiceProcessor{NewMyParentServiceProcessor(handler)}
...
func NewMyParentServiceProcessor(handler MyParentService) *MyParentServiceProcessor {
	self := &MyParentServiceProcessor{NewMyAnotherServiceProcessor(handler)}
	self.AddToProcessorMap("M11", &myParentServiceProcessorM11{handler: handler})
	self.AddToProcessorMap("M22", &myParentServiceProcessorM22{handler: handler})
	return self
}

type myParentServiceProcessorM11 struct {
	handler MyParentService
}

func (p *myParentServiceProcessorM11) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := MyParentServiceM11Args{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("M11", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := MyParentServiceM11Result{}
	var retval string
	if retval, err2 = p.handler.M11(ctx); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing M11: "+err2.Error())
		oprot.WriteMessageBegin("M11", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("M11", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type myParentServiceProcessorM22 struct {
	handler MyParentService
}

func (p *myParentServiceProcessorM22) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := MyParentServiceM22Args{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("M22", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := MyParentServiceM22Result{}
	var retval string
	if retval, err2 = p.handler.M22(ctx); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing M22: "+err2.Error())
		oprot.WriteMessageBegin("M22", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("M22", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
func (p *MyParentServiceM11Args) Write(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteStructBegin("M11_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
	}
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_MyParentServiceM11Result[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *MyParentServiceM11Result) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("M11_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *MyParentServiceM11Result) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRING, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *MyParentServiceM22Args) Write(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteStructBegin("M22_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
	}
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_MyParentServiceM22Result[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *MyParentServiceM22Result) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("M22_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *MyParentServiceM22Result) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRING, 0); err != nil {
			goto WriteFieldBeginError
		}
