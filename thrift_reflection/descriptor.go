...
func (p *ConstDescriptor) ReadField4(iprot thrift.TProtocol) error {
	_field := NewConstValueDescriptor()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Value = _field
...
func (p *ConstValueDescriptor) ReadField1(iprot thrift.TProtocol) error {
	...
	var _field ConstValueType
	if v, err := iprot.ReadI32(); err != nil {
		return err
	} else {
		_field = ConstValueType(v)
	}
	p.Type = _field
	return nil
}
...
func (p *ConstValueDescriptor) ReadField6(iprot thrift.TProtocol) error {
	...
	_field := make([]*ConstValueDescriptor, 0, size)
	values := make([]ConstValueDescriptor, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
...
func (p *ConstValueDescriptor) ReadField7(iprot thrift.TProtocol) error {
	...
	_field := make(map[*ConstValueDescriptor]*ConstValueDescriptor, size)
	values := make([]ConstValueDescriptor, size)
	for i := 0; i < size; i++ {
...
func (p *ConstValueDescriptor) writeField9(oprot thrift.TProtocol) (err error) {
	if p.IsSetExtra() {
...
func (p *EnumDescriptor) ReadField3(iprot thrift.TProtocol) error {
	...
	_field := make([]*EnumValueDescriptor, 0, size)
	values := make([]EnumValueDescriptor, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
...
func (p *StructDescriptor) ReadField3(iprot thrift.TProtocol) error {
	...
	_field := make([]*FieldDescriptor, 0, size)
	values := make([]FieldDescriptor, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
...
func (p *ServiceDescriptor) ReadField3(iprot thrift.TProtocol) error {
	...
	_field := make([]*MethodDescriptor, 0, size)
	values := make([]MethodDescriptor, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
...
func (p *ServiceDescriptor) writeField7(oprot thrift.TProtocol) (err error) {
	if p.IsSetBase() {
		if err = oprot.WriteFieldBegin("base", thrift.STRING, 7); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteString(p.Base); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *FileDescriptor) ReadField4(iprot thrift.TProtocol) error {
	...
	_field := make([]*ServiceDescriptor, 0, size)
	values := make([]ServiceDescriptor, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
...
func (p *FileDescriptor) ReadField5(iprot thrift.TProtocol) error {
	...
	_field := make([]*StructDescriptor, 0, size)
	values := make([]StructDescriptor, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
...
func (p *FileDescriptor) ReadField7(iprot thrift.TProtocol) error {
	...
	_field := make([]*EnumDescriptor, 0, size)
	values := make([]EnumDescriptor, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
...
func (p *FileDescriptor) ReadField8(iprot thrift.TProtocol) error {
	...
	_field := make([]*TypedefDescriptor, 0, size)
	values := make([]TypedefDescriptor, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
...
func (p *FileDescriptor) ReadField10(iprot thrift.TProtocol) error {
	...
	_field := make([]*ConstDescriptor, 0, size)
	values := make([]ConstDescriptor, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
