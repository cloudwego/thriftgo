...
func (p *_StructOptions) ReadField3(iprot thrift.TProtocol) error {
	...
	p.PersonEnumInfo = _field
	return nil
}
func (p *_StructOptions) ReadField4(iprot thrift.TProtocol) error {

	var _field MyBasicTypedef
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		_field = v
	}
	p.PersonBasicTypedefInfo = _field
	return nil
}
func (p *_StructOptions) ReadField5(iprot thrift.TProtocol) error {
	_field := NewMyStructTypedef()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.PersonStructTypedefInfo = _field
	return nil
}
func (p *_StructOptions) ReadField6(iprot thrift.TProtocol) error {
	_field := NewMyStructWithDefaultVal()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.PersonStructDefaultValueInfo = _field
	return nil
}
