...
func (p *_StructOptions) ReadField1(iprot thrift.TProtocol) error {
	_field := NewPersonBasicInfo()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.PersonBasicInfo = _field
	return nil
}
func (p *_StructOptions) ReadField2(iprot thrift.TProtocol) error {
	_field := NewPersonStructInfo()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.PersonStructInfo = _field
	return nil
}
func (p *_StructOptions) ReadField3(iprot thrift.TProtocol) error {
	_field := NewPersonContainerInfo()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.PersonContainerInfo = _field
	return nil
}
...
func (p *PersonContainerInfo) ReadField5(iprot thrift.TProtocol) error {
	...
	_field := make([][]*InnerStruct, 0, size)
	for i := 0; i < size; i++ {
		_, size, err := iprot.ReadSetBegin()
		if err != nil {
			return err
...
func (p *PersonContainerInfo) ReadField6(iprot thrift.TProtocol) error {
	...
	_field := make(map[string]*InnerStruct, size)
	values := make([]InnerStruct, size)
	for i := 0; i < size; i++ {
		var _key string
		if v, err := iprot.ReadString(); err != nil {
...
func (p *PersonStructInfo) ReadField1(iprot thrift.TProtocol) error {
	_field := NewTestStruct()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Valueteststruct = _field
	return nil
}
func (p *PersonStructInfo) ReadField2(iprot thrift.TProtocol) error {
	_field := NewInnerStruct()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Valuestruct = _field
	return nil
}
...
func (p *PersonStructInfo) ReadField4(iprot thrift.TProtocol) error {
	_field := NewTestStructTypedef()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Valuestructtypedef = _field
	return nil
}
func (p *PersonStructInfo) ReadField5(iprot thrift.TProtocol) error {

	var _field TestBasicTypedef
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		_field = v
	}
	p.Valuebasictypedef = _field
	return nil
}
